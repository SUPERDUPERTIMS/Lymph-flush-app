...
""", unsafe_allow_html=True)
    ...
    st.markdown("<h3 style='text-align: center; color: #333; margin-bottom: 20px;'>Select training focus:</h3>", unsafe_allow_html=True)
    ...
    default_idx = protocol_options.index(current_selected) if current_selected in protocol_options else 0
